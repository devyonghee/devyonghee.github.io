...
{% include image.html path="assets/images/documentation/sample-image.jpg" path-detail="assets/images/documentation/sample-image@2x.jpg" alt="Sample image" %}

{% highlight liquid %}
{% raw %}
{% include image.html path="assets/images/documentation/sample-image.jpg" alt="Sample image" %}
{% endraw %}
{% endhighlight %}
