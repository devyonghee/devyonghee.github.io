...
thumb_image: "assets/images/documentation/sample-image.jpg"
tags: [web, jekyll]
---

{% include image.html path="assets/images/documentation/chalk-intro.png" path-detail="assets/images/documentation/chalk-intro@2x.png" alt="Chalk intro" %}
...
{% include image.html path="assets/images/documentation/enlarge.gif" path-detail="assets/images/documentation/enlarge@2x.gif" alt="Enlarge image feature" %}
